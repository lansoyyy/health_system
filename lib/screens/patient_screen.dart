                              ...
                              GestureDetector(
                                onTap: (() async {
                                  if (notesController.text == '') {
                                    showToast('Update failed! No new Input');
                                  } else {
                                    showToast('Findings updated succesfully!');
                                    await FirebaseFirestore.instance
                                        .collection('Patient')
                                        .doc(data['id'])
                                        .update({
                                      'medicalFindings': notesController.text
                                    });
                                  }
                                }),
                                child: Row(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextRegular(
                                  text: 'Complete Address: ${data['address']}',
                                  fontSize: 15,
                                  color: Colors.black),
                            ],
                          ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextRegular(
                                    text: 'Assisted by: ${data['assistedBy']}',
                                    fontSize: 15,
                                    color: Colors.black),
                              ],
                            ),
